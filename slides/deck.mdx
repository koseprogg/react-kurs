...
Lag en Message komponent vi kan bruke flere ganger, sånn at vi ikke gjenntar oss så mange ganger?
...
<Step title="Dette gjør det mye lettere å lage dynamiske nettsider som har varierende innhold">
