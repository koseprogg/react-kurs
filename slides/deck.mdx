...
```diff 4[2:26] subtitle="Her bruker vi 'array destructuring' for å definere to variabler som useState lager. Den første er selve staten, og den andre er en funksjon som setter staten vår"
...
<Step title="Vi er ikke limeted til å ha bare en state. Vi kan kalle useState så mange ganger vi vil og lage flere states som holder styr på hver sin verdi">
